...
_define_property(CurrentSongVerse, "discriminator", 7);
...
_define_property(Info, "discriminator", 1);
...
_define_property(Error, "discriminator", 2);
...
export var MarkSongVerse = /*#__PURE__*/ function() {
    "use strict";
    function MarkSongVerse(record) {
        _class_call_check(this, MarkSongVerse);
        _define_property(this, "discriminator", 5);
        _define_property(this, "songHash", void 0);
        _define_property(this, "verseIdx", void 0);
        this.songHash = record.songHash;
   ...
   */ function fromJSON(json) {
    ...
    return MarkSongVerse;
}();
_define_property(MarkSongVerse, "discriminator", 5);
export var Message = /*#__PURE__*/ function() {
    ...
    _create_class(Message, [
        ...
        },
        {
            ...
            value: function isInfo() {
                return _instanceof(this.data.value, Info);
            }
        },
        {
            key: "isError",
            value: function isError() {
                return _instanceof(this.data.value, Error);
            }
        },
        {
            key: "isHelloResponse",
        ...
        {
            key: "isMarkSongVerse",
            value: function isMarkSongVerse() {
                return _instanceof(this.data.value, MarkSongVerse);
            }
        },
        {
            key: "stringify",
   ...
   */ function validateTypes() {
        ...
        {
            key: "fromError",
            value: function fromError(value) {
                return new Message({
                    discriminator: 2,
        ...
        {
            key: "fromMarkSongVerse",
            value: function fromMarkSongVerse(value) {
                return new Message({
                    discriminator: 5,
                    value: new MarkSongVerse(value)
                });
            }
        },
        {
                    ...
                    case 1:
                        {
                            return new Message({
                                discriminator: 1,
                                value: Info.unsafeCast(record.value)
                            });
                        }
                    case 2:
                        {
                            return new Message({
                                discriminator: 2,
                                value: Error.unsafeCast(record.value)
                            });
                        }
                    case 3:
                        {
                    ...
                    case 5:
                        {
                            return new Message({
                                discriminator: 5,
                                value: MarkSongVerse.unsafeCast(record.value)
                            });
                        }
                }
                throw new BebopRuntimeError("Failed to unsafely cast union from discriminator: ".concat(discriminator));
