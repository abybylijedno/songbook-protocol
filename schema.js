...
export var SessionDeleteReason = /*#__PURE__*/ function(SessionDeleteReason) {
    SessionDeleteReason[SessionDeleteReason["Expired"] = 1] = "Expired";
    SessionDeleteReason[SessionDeleteReason["CreatorsDecision"] = 2] = "CreatorsDecision";
    SessionDeleteReason[SessionDeleteReason["UserLeft"] = 3] = "UserLeft";
    return SessionDeleteReason;
}({});
export var ErrorCode = /*#__PURE__*/ function(ErrorCode) {
    ErrorCode[ErrorCode["Unknown"] = 1] = "Unknown";
    ErrorCode[ErrorCode["InvalidCommand"] = 2] = "InvalidCommand";
    ErrorCode[ErrorCode["SessionNotFound"] = 3] = "SessionNotFound";
    ErrorCode[ErrorCode["SessionIdRequired"] = 4] = "SessionIdRequired";
    ErrorCode[ErrorCode["SessionYouHaveOne"] = 5] = "SessionYouHaveOne";
    ErrorCode[ErrorCode["SessionYouHaveNone"] = 6] = "SessionYouHaveNone";
    ErrorCode[ErrorCode["SessionYouAreNotCreator"] = 7] = "SessionYouAreNotCreator";
    ErrorCode[ErrorCode["SessionYouAreNotMember"] = 8] = "SessionYouAreNotMember";
    ErrorCode[ErrorCode["SessionCannotLeaveAsCreator"] = 9] = "SessionCannotLeaveAsCreator";
    ErrorCode[ErrorCode["SongNotFound"] = 10] = "SongNotFound";
    ErrorCode[ErrorCode["SongHashRequired"] = 11] = "SongHashRequired";
    ErrorCode[ErrorCode["SongVerseIdxRequired"] = 12] = "SongVerseIdxRequired";
    ErrorCode[ErrorCode["SongVerseIdxInvalid"] = 13] = "SongVerseIdxInvalid";
    ErrorCode[ErrorCode["SongVerseDoesNotExist"] = 14] = "SongVerseDoesNotExist";
    return ErrorCode;
}({});
...
_define_property(ErrorMessage, "discriminator", 1);
...
_define_property(HelloResponse, "discriminator", 2);
...
_define_property(SessionDetails, "discriminator", 3);
export var SessionDeleted = /*#__PURE__*/ function() {
    "use strict";
    function SessionDeleted(record) {
        _class_call_check(this, SessionDeleted);
        _define_property(this, "discriminator", 4);
        _define_property(this, "reason", void 0);
        this.reason = record.reason;
    }
    _create_class(SessionDeleted, [
        {
            key: "stringify",
            value: /**
   * Serializes the current instance into a JSON-Over-Bebop string
...
_define_property(SessionDeleted, "discriminator", 4);
...
export var Message = /*#__PURE__*/ function() {
    ...
    _create_class(Message, [
        ...
        {
            key: "isSessionDeleted",
            value: function isSessionDeleted() {
                return _instanceof(this.data.value, SessionDeleted);
            }
        },
        {
   ...
   */ function validateTypes() {
        ...
        {
            key: "fromSessionDeleted",
            value: function fromSessionDeleted(value) {
                return new Message({
                    discriminator: 4,
                    value: new SessionDeleted(value)
                });
            }
        },
        {
                    ...
                    case 4:
                        {
                            return new Message({
                                discriminator: 4,
                                value: SessionDeleted.unsafeCast(record.value)
                            });
                        }
                    case 5:
                        {
