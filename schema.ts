...
0, 10, 0, 0, 0, 83, 79, 78, 71, 95, 83, 76, 85, 71, 95,
...
101, 0, 1, 0, 0, 5, 0, 0, 0, 0, 2, 115, 111, 110, 103, 83,
108, 117, 103, 0, 245, 255, 255, 255, 0, 118, 101, 114,
...
0, 0, 5, 0, 0, 0, 0, 2, 115, 111, 110, 103, 83, 108, 117,
103, 0, 245, 255, 255, 255, 0, 118, 101, 114, 115, 101,
...
export class SpreadSongVerse implements ISpreadSongVerse {
  ...
  public static validateCompatibility(record: ISpreadSongVerse): void {
    BebopTypeGuard.ensureString(record.songSlug)
  ...
  public static encodeInto(record: ISpreadSongVerse, view: BebopView): number {
    const before = view.length;
    view.writeString(record.songSlug);
